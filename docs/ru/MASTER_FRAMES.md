...
### Мастер-дарки + Файлы косметической коррекции

```bash
# Автосоздание дарков, сгруппированных по выдержке + генерация списков для косметической коррекции
...
- Та же оптическая конфигурация, что и у лайтов, те же фильтры и поворот

---

## Справочник по инструментам

### med.py — Медианное объединение, используется для мастер-BIAS
